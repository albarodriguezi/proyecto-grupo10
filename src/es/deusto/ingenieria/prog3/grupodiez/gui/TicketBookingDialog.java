...
public class TicketBookingDialog extends JDialog { //para interactuar con el usuario
    ...
    public TicketBookingDialog(Concert concert, Fecha fecha) {
        ...
        jPanelConcert.add(new JLabel(String.format("Fecha: %s - %s", fecha.getFecha())));
        jPanelConcert.add(new JLabel(String.format("Duración: %d m.", concert.getDuration())));
        jPanelConcert.add(new JLabel(String.format("Precio: %.2f €", concert.getPrice())));

        // Panel para los datos personales
        JPanel jPanelAudience = new JPanel();
        jPanelAudience.setBorder(new TitledBorder("Datos personales"));
        ...
        // Evento para el cambio en el número de asientos
        jSpinnerSeats.addChangeListener((e) -> {
            ...
            if (newSeats != seats) {
                ...
                jLabelAmount.setText(String.format("Importe total (%d x %.2f €): %.2f €", seats, concert.getPrice(), (concert.getPrice() * seats)));
            }
        });
        ...
        // Evento para introducir datos personales
        jComboPassengers.addActionListener((e) -> {
            ...
            if (passenger.contains("¿?")) {
                ...
                JComponent[] inputs = new JComponent[] {
                    new JLabel("Nombre: "), firstName,
                    new JLabel("Apellidos: "), lastName,
                };
        ...
        // Panel para seleccionar el número de tickets y mostrar el importe total
